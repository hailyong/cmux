...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.betaFeatures, "cosmos", String(localized: "settings.betaFeatures.cosmos", defaultValue: "Cosmos Sidebar"), "cosmos deep space planet workspace orb sidebar theme"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        CosmosSidebarSettings.enabledKey: settingID(for: .betaFeatures, idSuffix: "cosmos"),
